...
const RoomConnect = styled(Connect)`
	...
	filter: drop-shadow(0 0 0.5rem #e62097);
`;
	...
	return (
		<>
			...
			<RoomConnect
				onClick={() => {
					axios
						.post("/rooms/create", { user: "maliiii" })
						.then((res) => {
		...
		<Wrapper>
			{userObj ? ( // prevent forced relogin
				...
				<>
					...
					<Subheading>
						Sign in with Spotify to start listening:
					</Subheading>
					<SpotifyConnect>
						<Image src="https://p1.hiclipart.com/preview/893/800/19/spotify-for-os-x-el-capitan-spotify-icon.jpg"></Image>
						<SpotifyButton href="/auth/spotify">
							Connect
						</SpotifyButton>
					</SpotifyConnect>
				</>
				...
				<CodeInput
					...
					onKeyDown={(e) => {
						if (e.key === "Enter") {
							...
							setCode(code + e.key.toUpperCase());
						} else {
